...
function updateFooterRight() {
    ...
    const link = document.createElement('a');
    link.href = 'https://github.com/nezhahq/nezha';
    link.target = '_blank';
    link.className = 'footer-link';
    link.style.color = '#888';
    link.style.textDecoration = 'none';
    link.innerHTML = `<i class="fab fa-github rotate-icon" style="margin-right: 6px;"></i> Powered by NeZha`;
